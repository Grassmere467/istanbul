...
exports.init = function(config, clientResultsCallback){
    ...
    var resultsStartUrl = '/results/';
    var clientPostResultsStartUrl = '/clientResults/';
    ...
    connect.createServer(
        function (req, res, next) {
            ...
            if (startsWith(req.url, resultsStartUrl)){
                ...
                //clientResultsCallback(req.body);
                //res.end();
                return; 
    ...
    var clientPostingResultsProxy = httpProxy.createProxyServer({
       target: 'http://localhost:' + clientPostingResultsPort
    });
