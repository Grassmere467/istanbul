...
function defaultConfig() {
    var ret = {
        ...
        realtime: {
            ...
            proxyPort: 7002,
            appPort: 7004,
            clientPostInterval: 8000,
            exclude: [],
            resultsStartUrl: '/results/',
            clientPostResultsStartUrl: '/clientsResults/' 
        }
    };
...
function RealtimeOptions(config){
    this.config = config;
}

//addMethods(RealtimeOptions, 'enabled', 'resultPort');
...
function Configuration(obj, overrides) {
    ...
    this.realtime = new RealtimeOptions(config.realtime);
